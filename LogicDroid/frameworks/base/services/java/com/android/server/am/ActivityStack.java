...
final class ActivityStack {
    ...
    final int startActivityLocked(IApplicationThread caller,
        ...
        // hack - hendra
        // ##############################################################################
        // #                        Hook on Starting Activity                           #
        // ##############################################################################
		//if (monitorCall(aInfo.permission, callingUid, aInfo.applicationInfo.uid, aInfo.exported ? -1 : aInfo.applicationInfo.uid))
	//Log.i("LogicDroid", "ActivityStack : calling checkEvent on AMS for " + callingUid + ", " + aInfo.applicationInfo.uid);
        if (mService.checkEvent(new Event("call", callingUid, aInfo.applicationInfo.uid), System.currentTimeMillis()))
		{
