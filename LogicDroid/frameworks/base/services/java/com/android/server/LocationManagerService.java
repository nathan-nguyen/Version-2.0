...
public class LocationManagerService extends ILocationManager.Stub implements Runnable {
	...
	// hack - hendra
	// ###########################################################################
	// #                   Hook on Accessing Location Update                     #
	// ###########################################################################
	try
	{
		mContext.checkPrivilegeEscalation(-1, Monitor.LOCATION_UID, System.currentTimeMillis(), ACCESS_FINE_LOCATION);        
	}
	catch (PrivilegeEscalationException pe)
	{
		// just log then terminate
		Log.e("LogicDroid", "request location updates failed because privilege escalation is detected");
		return;
	}
	catch (SecurityException se)
	{
