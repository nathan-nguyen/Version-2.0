...
public abstract class ActivityManagerNative extends Binder implements IActivityManager
{
    ...
    public boolean onTransact(int code, Parcel data, Parcel reply, int flags)
	    ...
	    // hack - hendra
	    // #####################################################################################
	    // #                  Interface to Monitor from ActivityManagerNative                  #
	    // #####################################################################################
	    case CHECK_PRIVILEGE_ESCALATION_TRANSACTION:
        {
            // Log.i("track - ActivityManagerNative", "CHECK_PRIVILEGE_ESCALATION_TRANSACTION");
	        ...
	        //int res = (Monitor.checkEvent(new Event("call", vars, 2), timestamp)) ? 1 : 0;
            int res = (checkEvent(new Event("call", source, target), timestamp)) ? 1 : 0;
	        reply.writeNoException();
	        reply.writeInt(res);
            return true;
        }

	    case RENEW_MONITOR_VARIABLE_TRANSACTION:
        {
            // Log.i("track - ActivityManagerNative", "RENEW_MONITOR_VARIABLE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            String varName = data.readString();
            int varCount = data.readInt();
            ArrayList<Integer> vars = new ArrayList<Integer>(varCount);
            for (int i = 0; i < varCount; i++) vars.add(data.readInt());
            byte value = data.readByte();
	        //Monitor.renewMonitorVariable(varName, value == 1, vars.get(0));
	        renewMonitorVariable(varName, value == 1, vars.get(0));
            reply.writeNoException();
            return true;
        }
	    // #####################################################################################
        ...
        {
	    // Log.i("track - ActivityManagerNative", "START_ACTIVITY_TRANSACTION");
        ...
        {
	    // Log.i("track - ActivityManagerNative", "START_ACTIVITY_AND_WAIT_TRANSACTION");
        ...
        {
	    // Log.i("track - ActivityManagerNative", "START_ACTIVITY_WITH_CONFIG_TRANSACTION");
        ...
        {
		// Log.i("track - ActivityManagerNative", "START_ACTIVITY_INTENT_SENDER_TRANSACTION");
        ...
        {
	    // Log.i("track - ActivityManagerNative", "START_NEXT_MATCHING_ACTIVITY_TRANSACTION:");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "FINISH_ACTIVITY_TRANSACTION: {");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "FINISH_SUB_ACTIVITY_TRANSACTION: {");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
            String resultWho = data.readString();    
            int requestCode = data.readInt();
		...
		// Log.i("track - ActivityManagerNative", "FINISH_ACTIVITY_AFFINITY_TRANSACTION: {");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "WILL_ACTIVITY_BE_VISIBLE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
        ...
        {
	    // Log.i("track - ActivityManagerNative", "REGISTER_RECEIVER_TRANSACTION:");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder b = data.readStrongBinder();
        ...
        {
	    // Log.i("track - ActivityManagerNative", "UNREGISTER_RECEIVER_TRANSACTION:");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder b = data.readStrongBinder();
            if (b == null) {
                return true;
        ...
        {
	    // Log.i("track - ActivityManagerNative", "BROADCAST_INTENT_TRANSACTION:");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder b = data.readStrongBinder();
            IApplicationThread app =
                b != null ? ApplicationThreadNative.asInterface(b) : null;
        ...
        {
	    // Log.i("track - ActivityManagerNative", "UNBROADCAST_INTENT_TRANSACTION:");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder b = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "FINISH_RECEIVER_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "ATTACH_APPLICATION_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "ACTIVITY_IDLE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "ACTIVITY_PAUSED_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "ACTIVITY_STOPPED_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
		...
		// Log.i("track - ActivityManagerNative", "ACTIVITY_SLEPT_TRANSACTION:");            
		data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
            activitySlept(token);
            reply.writeNoException();
	    ...
	    // Log.i("track - ActivityManagerNative", "ACTIVITY_DESTROYED_TRANSACTION:");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_CALLING_PACKAGE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_CALLING_ACTIVITY_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_TASKS_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_RECENT_TASKS_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            int maxNum = data.readInt();
            int fl = data.readInt();
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_TASK_THUMBNAILS_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            int id = data.readInt();
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_SERVICES_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            int maxNum = data.readInt();
            int fl = data.readInt();
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_PROCESSES_IN_ERROR_STATE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_RUNNING_APP_PROCESSES_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_RUNNING_EXTERNAL_APPLICATIONS_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "MOVE_TASK_TO_FRONT_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "MOVE_TASK_TO_BACK_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            int task = data.readInt();
            moveTaskToBack(task);
            reply.writeNoException();
	    ...
	    // Log.i("track - ActivityManagerNative", "MOVE_ACTIVITY_TASK_TO_BACK_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "MOVE_TASK_BACKWARDS_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            int task = data.readInt();
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_TASK_FOR_ACTIVITY_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "REPORT_THUMBNAIL_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
            Bitmap thumbnail = data.readInt() != 0
                ? Bitmap.CREATOR.createFromParcel(data) : null;
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_CONTENT_PROVIDER_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder b = data.readStrongBinder();
            IApplicationThread app = ApplicationThreadNative.asInterface(b);
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_CONTENT_PROVIDER_EXTERNAL_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            String name = data.readString();
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "PUBLISH_CONTENT_PROVIDERS_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder b = data.readStrongBinder();
            IApplicationThread app = ApplicationThreadNative.asInterface(b);
	    ...
	    // Log.i("track - ActivityManagerNative", "REF_CONTENT_PROVIDERS_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder b = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "UNSTABLE_PROVIDER_DIED_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder b = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "REMOVE_CONTENT_PROVIDER_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder b = data.readStrongBinder();
            boolean stable = data.readInt() != 0;
	    ...
	    // Log.i("track - ActivityManagerNative", "REMOVE_CONTENT_PROVIDER_EXTERNAL_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            String name = data.readString();
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_RUNNING_SERVICE_CONTROL_PANEL_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "START_SERVICE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder b = data.readStrongBinder();
            IApplicationThread app = ApplicationThreadNative.asInterface(b);
	    ...
	    // Log.i("track - ActivityManagerNative", "STOP_SERVICE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder b = data.readStrongBinder();
            IApplicationThread app = ApplicationThreadNative.asInterface(b);
            Intent service = Intent.CREATOR.createFromParcel(data);
	    ...
	    // Log.i("track - ActivityManagerNative", "STOP_SERVICE_TOKEN_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "SET_SERVICE_FOREGROUND_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            ComponentName className = ComponentName.readFromParcel(data);
            IBinder token = data.readStrongBinder();
            int id = data.readInt();
	    ...
	    // Log.i("track - ActivityManagerNative", "BIND_SERVICE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder b = data.readStrongBinder();
            IApplicationThread app = ApplicationThreadNative.asInterface(b);
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "UNBIND_SERVICE_TRANSACTION ");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder b = data.readStrongBinder();
            IServiceConnection conn = IServiceConnection.Stub.asInterface(b);
	    ...
	    // Log.i("track - ActivityManagerNative", "PUBLISH_SERVICE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
            Intent intent = Intent.CREATOR.createFromParcel(data);
	    ...
	    // Log.i("track - ActivityManagerNative", "UNBIND_FINISHED_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
            Intent intent = Intent.CREATOR.createFromParcel(data);
	    ...
	    // Log.i("track - ActivityManagerNative", "SERVICE_DONE_EXECUTING_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "START_INSTRUMENTATION_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            ComponentName className = ComponentName.readFromParcel(data);
            String profileFile = data.readString();
            int fl = data.readInt();
	    ...
	    // Log.i("track - ActivityManagerNative", "FINISH_INSTRUMENTATION_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder b = data.readStrongBinder();
            IApplicationThread app = ApplicationThreadNative.asInterface(b);
            int resultCode = data.readInt();
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_CONFIGURATION_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
        ...
        case UPDATE_CONFIGURATION_TRANSACTION: {
            data.enforceInterface(IActivityManager.descriptor);
	    // Log.i("track - ActivityManagerNative", "UPDATE_CONFIGURATION_TRANSACTION");
            Configuration config = Configuration.CREATOR.createFromParcel(data);
	    ...
	    // Log.i("track - ActivityManagerNative", "SET_REQUESTED_ORIENTATION_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_REQUESTED_ORIENTATION_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_ACTIVITY_CLASS_FOR_TOKEN_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_PACKAGE_FOR_TOKEN_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
            reply.writeNoException();
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_INTENT_SENDER_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            int type = data.readInt();
            String packageName = data.readString();
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "CANCEL_INTENT_SENDER_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_PACKAGE_FOR_INTENT_SENDER_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IIntentSender r = IIntentSender.Stub.asInterface(
                data.readStrongBinder());
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_UID_FOR_INTENT_SENDER_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IIntentSender r = IIntentSender.Stub.asInterface(
                data.readStrongBinder());
	    ...
	    // Log.i("track - ActivityManagerNative", "SET_PROCESS_LIMIT_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_PROCESS_LIMIT_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "SET_PROCESS_FOREGROUND_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "CHECK_PERMISSION_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            String perm = data.readString();
            int pid = data.readInt();
	    ...
	    // Log.i("track - ActivityManagerNative", "CHECK_URI_PERMISSION_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "CLEAR_APP_DATA_TRANSACTION:");
            data.enforceInterface(IActivityManager.descriptor);            
            String packageName = data.readString();
	    ...
	    // Log.i("track - ActivityManagerNative", "GRANT_URI_PERMISSION_TRANSACTION:");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder b = data.readStrongBinder();
            IApplicationThread app = ApplicationThreadNative.asInterface(b);
	    ...
	    // Log.i("track - ActivityManagerNative", "REVOKE_URI_PERMISSION_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder b = data.readStrongBinder();
            IApplicationThread app = ApplicationThreadNative.asInterface(b);
            Uri uri = Uri.CREATOR.createFromParcel(data);
	    ...
	    // Log.i("track - ActivityManagerNative", "SHOW_WAITING_FOR_DEBUGGER_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder b = data.readStrongBinder();
            IApplicationThread app = ApplicationThreadNative.asInterface(b);
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_MEMORY_INFO_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "UNHANDLED_BACK_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            unhandledBack();
            reply.writeNoException();
            return true;
	    ...
	    // Log.i("track - ActivityManagerNative", "OPEN_CONTENT_URI_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "GOING_TO_SLEEP_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            goingToSleep();
            reply.writeNoException();
            return true;
	    ...
	    // Log.i("track - ActivityManagerNative", "WAKING_UP_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            wakingUp();
            reply.writeNoException();
            return true;
	    ...
	    // Log.i("track - ActivityManagerNative", "SET_LOCK_SCREEN_SHOWN_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "SET_DEBUG_APP_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "SET_ALWAYS_FINISH_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "SET_ACTIVITY_CONTROLLER_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "ENTER_SAFE_MODE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            enterSafeMode();
            reply.writeNoException();
            return true;
	    ...
	    // Log.i("track - ActivityManagerNative", "NOTE_WAKEUP_ALARM_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "KILL_PIDS_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "KILL_PROCESSES_BELOW_FOREGROUND_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            String reason = data.readString();
	    ...
	    // Log.i("track - ActivityManagerNative", "START_RUNNING_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "HANDLE_APPLICATION_CRASH_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "HANDLE_APPLICATION_WTF_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder app = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "HANDLE_APPLICATION_STRICT_MODE_VIOLATION_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder app = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "SIGNAL_PERSISTENT_PROCESSES_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "KILL_BACKGROUND_PROCESSES_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            String packageName = data.readString();
	    ...
	    // Log.i("track - ActivityManagerNative", "KILL_ALL_BACKGROUND_PROCESSES_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "FORCE_STOP_PACKAGE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            String packageName = data.readString();
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_MY_MEMORY_STATE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_DEVICE_CONFIGURATION_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "PROFILE_CONTROL_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "SHUTDOWN_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "STOP_APP_SWITCHES_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            stopAppSwitches();
            reply.writeNoException();
            return true;
	    ...
	    // Log.i("track - ActivityManagerNative", "RESUME_APP_SWITCHES_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            resumeAppSwitches();
            reply.writeNoException();
            return true;
	    ...
	    // Log.i("track - ActivityManagerNative", "PEEK_SERVICE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            Intent service = Intent.CREATOR.createFromParcel(data);
            String resolvedType = data.readString();
	    ...
	    // Log.i("track - ActivityManagerNative", "START_BACKUP_AGENT_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "BACKUP_AGENT_CREATED_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            String packageName = data.readString();
	    ...
	    // Log.i("track - ActivityManagerNative", "UNBIND_BACKUP_AGENT_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            ApplicationInfo info = ApplicationInfo.CREATOR.createFromParcel(data);
        ...
        {
	    // Log.i("track - ActivityManagerNative", "START_ACTIVITY_IN_PACKAGE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            int uid = data.readInt();
            Intent intent = Intent.CREATOR.createFromParcel(data);
            String resolvedType = data.readString();
	    ...
	    // Log.i("track - ActivityManagerNative", "KILL_APPLICATION_WITH_UID_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            String pkg = data.readString();
            int uid = data.readInt();
	    ...
	    // Log.i("track - ActivityManagerNative", "CLOSE_SYSTEM_DIALOGS_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            String reason = data.readString();
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_PROCESS_MEMORY_INFO_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            int[] pids = data.createIntArray();
	    ...
	    // Log.i("track - ActivityManagerNative", "KILL_APPLICATION_PROCESS_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "OVERRIDE_PENDING_TRANSITION_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
            String packageName = data.readString();
	    ...
	    // Log.i("track - ActivityManagerNative", "IS_USER_A_MONKEY_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "FINISH_HEAVY_WEIGHT_APP_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "IS_IMMERSIVE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "SET_IMMERSIVE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "IS_TO_ACTIVITY_IMMERSIVE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "CRASH_APPLICATION_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            int uid = data.readInt();
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_PROVIDER_MIME_TYPE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            Uri uri = Uri.CREATOR.createFromParcel(data);
	    ...
	    // Log.i("track - ActivityManagerNative", "NEW_URI_PERMISSION_OWNER_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            String name = data.readString();
	    ...
	    // Log.i("track - ActivityManagerNative", "GRANT_URI_PERMISSION_FROM_OWNER_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "REVOKE_URI_PERMISSION_FROM_OWNER_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder owner = data.readStrongBinder();
            Uri uri = null;
            if (data.readInt() != 0) {
	    ...
	    // Log.i("track - ActivityManagerNative", "CHECK_GRANT_URI_PERMISSION_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "DUMP_HEAP_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            String process = data.readString();
        ...
        {
	    // Log.i("track - ActivityManagerNative", "START_ACTIVITIES_IN_PACKAGE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            int uid = data.readInt();
        ...
        {
	    // Log.i("track - ActivityManagerNative", "START_ACTIVITIES_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder b = data.readStrongBinder();
            IApplicationThread app = ApplicationThreadNative.asInterface(b);
            Intent[] intents = data.createTypedArray(Intent.CREATOR);
        ...
        {
	    // Log.i("track - ActivityManagerNative", "GET_FRONT_ACTIVITY_SCREEN_COMPAT_MODE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
        ...
        {
	    // Log.i("track - ActivityManagerNative", "SET_FRONT_ACTIVITY_SCREEN_COMPAT_MODE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            int mode = data.readInt();
        ...
        {
	    // Log.i("track - ActivityManagerNative", "GET_PACKAGE_SCREEN_COMPAT_MODE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            String pkg = data.readString();
        ...
        {
	    // Log.i("track - ActivityManagerNative", "SET_PACKAGE_SCREEN_COMPAT_MODE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            String pkg = data.readString();
            int mode = data.readInt();
	    ...
	    // Log.i("track - ActivityManagerNative", "SWITCH_USER_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            int userid = data.readInt();
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_CURRENT_USER_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
        ...
        {
	    // Log.i("track - ActivityManagerNative", "REMOVE_SUB_TASK_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
        ...
        {
	    // Log.i("track - ActivityManagerNative", "REMOVE_TASK_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            int taskId = data.readInt();
            int fl = data.readInt();
	    ...
	    // Log.i("track - ActivityManagerNative", "REGISTER_PROCESS_OBSERVER_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "UNREGISTER_PROCESS_OBSERVER_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IProcessObserver observer = IProcessObserver.Stub.asInterface(
                    data.readStrongBinder());
        ...
        {
	    // Log.i("track - ActivityManagerNative", "GET_PACKAGE_ASK_SCREEN_COMPAT_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            String pkg = data.readString();
        ...
        {
	    // Log.i("track - ActivityManagerNative", "SET_PACKAGE_ASK_SCREEN_COMPAT_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            String pkg = data.readString();
	    ...
	    // Log.i("track - ActivityManagerNative", "IS_INTENT_SENDER_TARGETED_TO_PACKAGE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IIntentSender r = IIntentSender.Stub.asInterface(
                data.readStrongBinder());
	    ...
	    // Log.i("track - ActivityManagerNative", "IS_INTENT_SENDER_AN_ACTIVITY_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IIntentSender r = IIntentSender.Stub.asInterface(
                data.readStrongBinder());
	    ...
	    // Log.i("track - ActivityManagerNative", "UPDATE_PERSISTENT_CONFIGURATION_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            Configuration config = Configuration.CREATOR.createFromParcel(data);
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_PROCESS_PSS_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            int[] pids = data.createIntArray();
	    ...
	    // Log.i("track - ActivityManagerNative", "SHOW_BOOT_MESSAGE_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "DISMISS_KEYGUARD_ON_NEXT_ACTIVITY_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
	    ...
	    // Log.i("track - ActivityManagerNative", "TARGET_TASK_AFFINITY_MATCHES_ACTIVITY_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "NAVIGATE_UP_TO_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
	    ...
	    // Log.i("track - ActivityManagerNative", "GET_LAUNCHED_FROM_UID_TRANSACTION");
            data.enforceInterface(IActivityManager.descriptor);
            IBinder token = data.readStrongBinder();
...
class ActivityManagerProxy implements IActivityManager
{
	// hack - hendra
	// ######################################################################################
	// #              Interface to Monitor from the remote app (different VM)               #
	// ######################################################################################  
	public boolean checkEvent(Event ev, long timestamp)
	{
		...
		int target = ev.vars.get(1);
		data.writeInt(ev.vars.get(0));
	...
	public void renewMonitorVariable(String rel, boolean value, int ... UID)
	{
		...
		Parcel reply = Parcel.obtain();
		data.writeInterfaceToken(IActivityManager.descriptor);
    	data.writeString(rel);
    	data.writeInt(UID.length);
    	for (int i = 0; i < UID.length; i++) data.writeInt(UID[i]);
		data.writeByte(value ? (byte)1 : (byte)0);
		try {
			mRemote.transact(RENEW_MONITOR_VARIABLE_TRANSACTION, data, reply, 0);
		} catch (RemoteException re)
		{
			Log.i("track - ActivityManagerNative", "renewMonitorVariable failed : " + re);
		}
		reply.readException();
		data.recycle();
		reply.recycle();
	...
	// Log.i("track - ActivityManagerNative", "Returning");
        reply.readException();
            ...
            String resolvedType) throws RemoteException
    {
        ...
        service.writeToParcel(data, 0);
        data.writeString(resolvedType);
	// Log.i("track - ActivityManagerNative", "Service : " + resolvedType);
    ...
    public int checkPermission(String permission, int pid, int uid)
        ...
        data.writeInt(pid);
        data.writeInt(uid);
	// Log.i("track - ActivityManagerNative", "checkPermission " + uid + " : " + permission);
	...
	// Log.i("track - ActivityManagerNative", "handleApplicationCrash");
