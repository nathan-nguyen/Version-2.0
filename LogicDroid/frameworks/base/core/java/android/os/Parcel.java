...
public final class Parcel {
	...
	private static final int EX_PRIVILEGE_ESCALATION = -6;
    ...
    public final void writeException(Exception e) {
        ...
        // #               Custom Exception                #
        // #################################################
		else if (e instanceof PrivilegeEscalationException){
			code = EX_PRIVILEGE_ESCALATION;
		}
        // #################################################
        writeInt(code);
    ...
    public final void readException(int code, String msg) {
        switch (code) {
            ...
            // #             Custom Exception              #
            // #############################################
			case EX_PRIVILEGE_ESCALATION:
				throw new PrivilegeEscalationException(msg);
            // #############################################
        }
