...
public class WebSettingsClassic extends WebSettings {
	...
	//{
		try
		{
			mContext.checkPrivilegeEscalation(android.os.Process.myUid(), Monitor.INTERNET_UID, System.currentTimeMillis(), "android.permission.INTERNET");
		}
		catch (PrivilegeEscalationException pe)
		{
			Log.e("LogicDroid", "blocking internet access because privilege escalation detected");
			mBlockNetworkLoads = true;
		}
	//}
	// ########################################################################
    ...
    private void verifyNetworkAccess() {
		...
		{
			Log.e("LogicDroid", "(verify network access) : blocking internet access because privilege escalation detected");
			mBlockNetworkLoads = true;
		}
		// ###################################################################
        }
