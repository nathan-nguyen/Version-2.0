...
public class PhoneSubInfo extends IPhoneSubInfo.Stub {
	...
	// LogicDroid
	// ##################################################################
	// #                     Hook on getting IMEI begins                #
	// ##################################################################
	Log.i("LogicDroid", "IMEI called by the process UID: " + Binder.getCallingUid() );
	try {
		mPhone.getContext().checkPrivilegeEscalation(Binder.getCallingUid(), Monitor.IMEI_UID, System.currentTimeMillis(), "android.permission.IMEI_INFO");
	}
	catch (PrivilegeEscalationException pe) {
		// do nothing, just log that it has been blocked
		Log.e("LogicDroid", "Getting IMEI number is blocked because Privilege Escalation is detected"); 
		//fake IMEI
		return "111111111111111";
	}

	// ##################################################################
	// #                     Hook on getting IMEI end                   #
	// ##################################################################
