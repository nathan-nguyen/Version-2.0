...
public class Formula {
	...
	public Formula(String subformula, String type, MetaFormula info)
	{
		...
		if (type.equals(GlobalVariable.AND) || type.equals(GlobalVariable.OR) || type.equals(GlobalVariable.SINCE)) // Either And or Or
		{
			int stackCount = 0;
			int startIdx;
			for(int i = 0; i < len; i++)
		...
		else
		{
			...
			if (type.equals(GlobalVariable.DIAMONDDOT) || type.equals(GlobalVariable.DIAMOND) ||
					type.equals(GlobalVariable.EXIST) || type.equals(GlobalVariable.FORALL))
			{
	...
	public Formula(Element subformula, String type, MetaFormula info)
	{
		...
		for (int i = 0; i < len; i++)
		{
			...
			{
				if (child.getNodeName().equals(GlobalVariable.ATOM))
				{
...
class UniversalFormula extends Formula
{
	...
	public UniversalFormula(Element subformula, String type, MetaFormula info)
	{
		...
		for (int i = 0; i < nl.getLength(); i++)
		{
			...
			if (child.getNodeType() == Node.ELEMENT_NODE && child.getNodeName().equals(GlobalVariable.VAR))
			{
