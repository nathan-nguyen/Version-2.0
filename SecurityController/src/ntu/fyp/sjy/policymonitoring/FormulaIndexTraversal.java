...
public class FormulaIndexTraversal {
	...
	private void traverse_DiamondDot(Formula policy, int indent_index, ArrayList<String> result, int policy_number, 
		...
		if (((DiamondDotFormula)policy).metric >= 0) {
			...
			if (debugMode == 2)
				Print.dependencyTable += "|05|" + ret.varIdx.size() + "|2|" + ret.firstIndexToString + secondIndexToString + "5|" + policy_number + "|" + curr_idx + "|" + subIndex + "|" + timetag_idx + "|" + ((DiamondDotFormula)policy).metric;
			...
			if (debugMode == 2)
				Print.dependencyTable += "|06|" + ret.varIdx.size() + "|2|" + ret.firstIndexToString + secondIndexToString + "3|" + policy_number + "|" + curr_idx + "|" + subIndex;
			...
			FirstIndexingReturn ret, StringBuilder formulaStr)
	{
		...
		if (((DiamondFormula)policy).metric >= 0) {
			...
			if (debugMode == 2)
				Print.dependencyTable += "|07|" + ret.varIdx.size() + "|2|" + ret.firstIndexToString + secondIndexToString + "5|" + policy_number + "|" + curr_idx + "|" + subIndex + "|" + timetag_idx + "|" + ((DiamondFormula)policy).metric;
			...
			if (debugMode == 2)
				Print.dependencyTable += "|08|" + ret.varIdx.size() + "|2|" + ret.firstIndexToString + secondIndexToString + "3|" + policy_number + "|" + curr_idx + "|" + subIndex;
			...
			FirstIndexingReturn ret, StringBuilder formulaStr)
	{
		...
		if (debugMode == 2)
			Print.dependencyTable += firstMessage + secondMessage;
	}
	...
	private void traverse_Exist(Formula policy, int indent_index, ArrayList<String> result, int policy_number, 
		...
		if (debugMode == 2)
			Print.dependencyTable += "|00|" + ret.varIdx.size() + "|2|" + ret.firstIndexToString + secondIndexToString + "3|" + policy_number + "|" + curr_idx + "|" + subIndex;	
	...
	private void traverse_Forall(Formula policy, int indent_index, ArrayList<String> result, int policy_number, 
		...
		if (debugMode == 2)
			Print.dependencyTable += "|04|" + ret.varIdx.size() + "|2|" + ret.firstIndexToString + secondIndexToString + "3|" + policy_number + "|" + curr_idx + "|" + subIndex + "\n";
	...
	private void traverse_Not(Formula policy, int indent_index, ArrayList<String> result, int policy_number, 
		...
		if (debugMode == 2)
			Print.dependencyTable += "|03|" + ret.varIdx.size() + "|2|" + ret.firstIndexToString + secondIndexToString + "3|" + policy_number + "|" + curr_idx + "|" + subIndex;
	...
	private void traverse_AndOr(Formula policy, int indent_index, ArrayList<String> result, int policy_number, 
		...
		if (debugMode == 2)
			Print.dependencyTable += message + secondMessage;
