...
// LogicDroid system calls
asmlinkage long sys_LogicDroid_checkChain(int policyID, int caller, int target);
asmlinkage long sys_LogicDroid_initializeMonitor(int __user *UID, int count);
asmlinkage long sys_LogicDroid_modifyStaticVariable(int policyID, int rel, int UID, char value);
asmlinkage long sys_LogicDroid_getRelationName(int ID, char __user *relationName);
asmlinkage long sys_LogicDroid_isMonitorPresent(void);
