...
int main( int argc, const char* argv[] ) { 
  ...
  for (int i = 0; i < 100; ++i) UID[i] = 5000 + i;

  sys_LogicDroid_initializeMonitor(UID, 100);
  ...
  sys_LogicDroid_checkChain(policyId, 5000, 5001);
  sys_LogicDroid_checkChain(policyId, 5001, 5002);
  sys_LogicDroid_checkChain(policyId, 5002, 5003);
  sys_LogicDroid_checkChain(policyId, 5003, 5004);
  sys_LogicDroid_checkChain(policyId, 5004, 5005);
  sys_LogicDroid_checkChain(policyId, 5005, 5006);
  sys_LogicDroid_checkChain(policyId, 5006, 5007);
  sys_LogicDroid_checkChain(policyId, 5007, 5008);
  sys_LogicDroid_checkChain(policyId, 5008, 5009);
  sys_LogicDroid_checkChain(policyId, 5009, 5010);
  sys_LogicDroid_checkChain(policyId, 5010, 1103);
